    ...
    <>
      <StepShell icon={<User size={18} className="text-teal-600" />} title="Personal information" subtitle="As per your official documents">
        <div className="space-y-4">
          ...
          <Field label="Mobile number" icon={<Smartphone size={16} className="text-slate-400 shrink-0" />} value={mobile} onChange={setMobile} placeholder="e.g. 17XXXXXX" type="number"/>
        </div>
      </StepShell>
      ...
      <StepNavigation backPath="" nextPath="/loan/otp" nextLabel="Continue to OTP" disabled={!valid} onNext={continueToOtp} loading={loading} />
    </>
  );
}
